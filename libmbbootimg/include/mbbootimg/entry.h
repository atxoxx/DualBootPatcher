...
#define MB_BI_ENTRY_KERNEL              (1ULL << 0)
#define MB_BI_ENTRY_RAMDISK             (1ULL << 1)
#define MB_BI_ENTRY_SECONDBOOT          (1ULL << 2)
#define MB_BI_ENTRY_DEVICE_TREE         (1ULL << 3)
#define MB_BI_ENTRY_ABOOT               (1ULL << 4)
#define MB_BI_ENTRY_MTK_KERNEL_HEADER   (1ULL << 5)
#define MB_BI_ENTRY_MTK_RAMDISK_HEADER  (1ULL << 6)
#define MB_BI_ENTRY_SONY_IPL            (1ULL << 7)
#define MB_BI_ENTRY_SONY_RPM            (1ULL << 8)
#define MB_BI_ENTRY_SONY_APPSBL         (1ULL << 9)
#define MB_BI_ENTRY_SONY_SIN            (1ULL << 10)
#define MB_BI_ENTRY_SONY_SIN_HEADER     (1ULL << 11)
...
MB_EXPORT int64_t mb_bi_entry_size(struct MbBiEntry *entry);
